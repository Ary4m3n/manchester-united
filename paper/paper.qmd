...
final_data_2013 <- read_parquet("../data/analysis_data/analysis_data2013.parquet", show_col_types = FALSE)

final_data_2013 <- final_data_2013 |>
  mutate_if(is.double, round, digits = 2)

kable(final_data_2013)
```
...
final_data_2023 <- read_parquet("../data/analysis_data/analysis_data2023.parquet", show_col_types = FALSE)

final_data_2023 <- final_data_2023 |>
  mutate_if(is.double, round, digits = 2)

kable(final_data_2023)
```
